...
public class XZ2SFC implements Serializable {
    private static List<XElement> LevelOneElements =
            new XElement(0.0, 0.0, 1.0, 1.0, 1.0).children();
    private static XElement levelTerminator = new XElement(-1.0, -1.0, -1.0, -1.0, 0);
    ...
    public static XZ2SFC getInstance(short g) {
        return cache.computeIfAbsent(g, g1 -> new XZ2SFC(g1, new Bound(
                CodeConstant.XZ2_X_MIN,
                CodeConstant.XZ2_Y_MIN,
                CodeConstant.XZ2_X_MAX,
                CodeConstant.XZ2_Y_MAX)));
    }
